...
namespace DistribuidoraLaVilla.Application.Interfaces
{
    public interface ICajaService
    {
        ...
        Task<CajaMovimientoDTO> RegistrarEgresoTransaccionalAsync(RegistrarEgresoDTO dto);
        Task<CajaMovimientoDTO?> RegistrarIngresoFacturaContadoTransaccionalAsync(int idFactura, decimal monto, Guid idUsuario, string? numeroFactura = null, int? metodoPago = null);
        ...
        Task<CajaMovimientoDTO?> RegistrarIngresoPagoCxcTransaccionalAsync(int idPago, int? idRecibo, decimal monto, Guid idUsuario, string? numeroRecibo = null, string? numeroFactura = null, int? metodoPago = null);
